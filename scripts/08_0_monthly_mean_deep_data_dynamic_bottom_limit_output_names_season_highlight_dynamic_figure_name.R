...
# This contains the central script-08 settings defined in scripts/03_define_assessment.R.
...
bottom_depth_limit_m <- indicator$near_bottom$bottom_depth_limit_m
bottom_depth_limit_label <- indicator$near_bottom$bottom_depth_limit_label
bottom_depth_limit_text <- indicator$near_bottom$bottom_depth_limit_text
bottom_suffix <- indicator$near_bottom$bottom_suffix
bottom_flag_col <- indicator$near_bottom$bottom_flag_col
profile_plot_months <- indicator$profile_months
profile_months_suffix <- indicator$profile_months_suffix

monthly_bottom_means_filename <- indicator$near_bottom$monthly_bottom_means_filename
monthly_bottom_oxygen_figure_filename <- indicator$near_bottom$monthly_bottom_oxygen_figure_filename
monthly_average_parameters <- indicator$near_bottom$monthly_average_parameters
min_oxygen_measurements_per_profile <- indicator$near_bottom$min_oxygen_measurements_per_profile
monthly_profile_figure_width <- indicator$near_bottom$monthly_profile_figure_width
monthly_profile_figure_height <- indicator$near_bottom$monthly_profile_figure_height
monthly_profile_figure_dpi <- indicator$near_bottom$monthly_profile_figure_dpi
monthly_profile_figure_max_depth <- indicator$near_bottom$monthly_profile_figure_max_depth
profile_colour_palette <- indicator$near_bottom$monthly_profile_colour_palette
profile_salinity_colour_palette <- indicator$near_bottom$monthly_profile_salinity_colour_palette
profile_salinity_colour_limits <- indicator$near_bottom$monthly_profile_salinity_colour_limits
monthly_bottom_figure_width <- indicator$near_bottom$monthly_bottom_figure_width
monthly_bottom_figure_height <- indicator$near_bottom$monthly_bottom_figure_height
monthly_bottom_figure_dpi <- indicator$near_bottom$monthly_bottom_figure_dpi
...
keep <- c("assessment", "indicator", "end_year", "start_year", "outputPath", "inputPath", "proj", "repo_url", "O2satFun", "auxilliaryFile",
          ...
          "monthly_average_parameters", "min_oxygen_measurements_per_profile",
          "monthly_profile_figure_width", "monthly_profile_figure_height", "monthly_profile_figure_dpi", "monthly_profile_figure_max_depth",
          "profile_colour_palette", "profile_salinity_colour_palette", "profile_salinity_colour_limits",
          "monthly_bottom_figure_width", "monthly_bottom_figure_height", "monthly_bottom_figure_dpi",
...
# 2. There are at least min_oxygen_measurements_per_profile measurements per profile.
oxy[, at_least_3_oxygen_measurements := 
      !is.na(n_Oxygen) &
      n_Oxygen >= min_oxygen_measurements_per_profile]


#-------------------------------------------------------------------------------
# Define parameter columns to average from scripts/03_define_assessment.R.
parameters <- intersect(monthly_average_parameters, names(oxy))
...
#
# The months used here are controlled by profile_plot_months from scripts/03_define_assessment.R.
...
plot_monthly_mean_profile_panels <- function(data,
                                             ...
                                             output_dir,
                                             width = monthly_profile_figure_width,
                                             height = monthly_profile_figure_height,
                                             dpi = monthly_profile_figure_dpi,
                                             max_depth = monthly_profile_figure_max_depth) {
...
plot_monthly_scatter <- function(data,
                                 ...
                                 width = monthly_bottom_figure_width,
                                 height = monthly_bottom_figure_height,
                                 dpi = monthly_bottom_figure_dpi) {
