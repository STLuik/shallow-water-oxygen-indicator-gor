...
#      deepest selected record is at or below the configured minimum depth, then averages those values by year.
...
#
# Inputs:
#   - monthly_mean_profiles_1m_<seasonal/monthly>_<method>_smoothed_months_<configured_months>.csv
#     created by script 08_1 and used by script 08_2.
#   - oxy_clean.csv created by script 07_data_preparation.R.
#
# Outputs:
#   - FIG_yearly_DO_debt_profiles_and_deep_profile_deepest_seasonal_averages_extra_TS_min<configured_depth>m_<mode>_<method>_months_<configured_months>.jpg
#   - FIG_deep_profile_deepest_selected_values_4panel_percentiles_<start>_to_end_baseline_<baseline>_min<configured_depth>m_<mode>_<method>_months_<configured_months>.jpg
#   - smoothed_profile_values_wide_DO_debt_profiles_<mode>_<method>_months_<configured_months>.csv
...
#   - deep_profile_deepest_selected_values_percentiles_<baseline>_min<configured_depth>m_<mode>_<method>_months_<configured_months>.csv
#
# Configuration is read from scripts/03_define_assessment.R.
...
profile_months <- indicator$deep_values$profile_months
seasonal_average_first <- indicator$deep_values$seasonal_average_first
smooth_method <- indicator$deep_values$smooth_method

profile_variable_observed <- indicator$deep_values$profile_variable_observed
profile_variable_smoothed <- indicator$deep_values$profile_variable_smoothed
profile_variable_label <- indicator$deep_values$profile_variable_label

deepest_variables <- indicator$deep_values$deepest_variables
panel_b_variable_labels <- indicator$deep_values$panel_b_variable_labels
deepest_units <- indicator$deep_values$deepest_units

deepest_min_depth_m <- indicator$deep_values$deepest_min_depth_m

bottom_suffix <- indicator$near_bottom$bottom_suffix

figure_width <- indicator$deep_values$figure_width
figure_height <- indicator$deep_values$figure_height
figure_dpi <- indicator$deep_values$figure_dpi
deep_values_4panel_figure_width <- indicator$deep_values$deep_values_4panel_figure_width
deep_values_4panel_figure_height <- indicator$deep_values$deep_values_4panel_figure_height

deep_values_plot_start_year <- indicator$deep_values$deep_values_plot_start_year
deep_values_percentile_baseline_start_year <- indicator$deep_values$deep_values_percentile_baseline_start_year
deep_values_percentile_baseline_end_year <- indicator$deep_values$deep_values_percentile_baseline_end_year
deep_values_percentile_probs <- indicator$deep_values$deep_values_percentile_probs
...
ggplot2::ggsave(
  ...
  width = deep_values_4panel_figure_width,
  height = deep_values_4panel_figure_height,
  units = "in",
  dpi = figure_dpi
)
